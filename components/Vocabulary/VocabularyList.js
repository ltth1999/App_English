...
class Basic extends Component{
  ...
  _renderItemVoca(item){
    ...
    if(theme==0||theme==item.categorie){
      return(
        <TouchableOpacity  onPress={() => navigate('Chi tiết từ vựng', item)} >
...
export default function VocabularyList() {
  return (
    <VocaStack.Navigator initialRouteName="Bài Tập Cơ Bản" >
      <VocaStack.Screen name="Bài Tập Cơ Bản" component={Basic}/>
      <VocaStack.Screen name="Chi tiết từ vựng" component={VocaDetail}/>
    </VocaStack.Navigator>
  );
}